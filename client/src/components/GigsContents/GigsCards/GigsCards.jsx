  ...
  return (
    ...
    >
      <img
        src={item?.cover}
        alt={item?.username}
        className="w-full object-cover group-hover:opacity-80 transition-all duration-300 h-[200px]"
      />
      <div className="w-full bg-white pt-5 flex items-start flex-col gap-3 justify-start">
        ...
        <p className="text-darkColor text-sm group-hover:text-primary transition-all duration-300 px-4">
